...
x = torch.tensor([[1.0, 2.0, 3.0]])  # 1x3
...
w = torch.tensor([[-0.5, -0.3], [0.2, 0.4], [0.1, 0.15]])  # 3x2
...
x_input = torch.tensor([[100.0, 200.0, 300.0]])  # 1x3
...
y1 = torch.tensor([[1.0, 3.0, 5.0, 7.0]])
...
x_in = torch.tensor([[100.0, 200.0, 300.0]])
