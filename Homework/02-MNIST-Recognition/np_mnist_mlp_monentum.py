...
# 训练结果：epoch: 10, val_loss: 0.0923, val_acc: 0.9723
...
class Network(object):
    ...
    def __init__(self, input_size, hidden_size, output_size, lr=0.01, momentum=0.2):
        """
        初始化网络结构
        """
        self.lr = lr
    ...
    def step(self, x_batch, y_batch):
        ...
        # 更新权重
        self.momentum_W3 = self.momentum * self.momentum_W3 + grad_W3
        self.momentum_W2 = self.momentum * self.momentum_W2 + grad_W2
        self.momentum_W1 = self.momentum * self.momentum_W1 + grad_W1
...
if __name__ == "__main__":
    # 训练网络
    net = Network(
        input_size=784, hidden_size=256, output_size=10, lr=0.03, momentum=0.3
    )
